...
import 'screens/customer/order/order_model.dart';

/// Layanan pesanan (Create, Read, Update, Delete).
///
/// Saat ini data disimpan di memori (singleton) sehingga semua halaman
/// berbagi data yang sama. Ketika API backend sudah siap, cukup ganti isi
/// method-method di class ini dengan pemanggilan HTTP; UI tidak perlu diubah.
class OrderService extends ChangeNotifier {
  ...
  Future<Order> createOrder({
    ...
    // Kelompokkan per UMKM (urutan sesuai kemunculan di keranjang).
  ...
  /// Unggah (atau ganti) bukti transfer, lalu pesanan masuk tahap ditinjau UMKM.
  ...
  /// COD: tidak ada bukti transfer, pesanan langsung diteruskan ke UMKM.
  ...
  /// Menggeser status ke tahap berikutnya (simulasi respon UMKM / kurir).
  ...
  /// Data contoh: pesanan PO aktif seperti pada desain "Status Pesanan".
  void _seed() {
    _orders.add(Order(
      id: 'ORD-20260915-001',
...
/// Contoh isi keranjang (sesuai desain Checkout) untuk mencoba alur pesanan.
/// Nanti diganti dengan data asli dari halaman Keranjang.
class SampleData {
